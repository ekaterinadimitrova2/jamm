...
public class MemoryMeterTest {
    ...
    public void testIgnoreNonStrongReferences() throws InterruptedException {
        ...
        MemoryMeter meterMeasuring = MemoryMeter.builder().withGuessing(guess).measureNonStrongReferences().printVisitedTree().build();
        ...
        long lockSize = meterIgnoring.measure(new Object()); // The lock has the same size as an empty object.
